...
function obtenerResto(x, y) { var obtenerResto = x % y;
  return obtenerResto
...
function obtenerSaludo(nombre) {return nombre = ('Hola' +' '+ nombre +'!')
...
function deEuroAdolar(euro){return dolar = euro * 1.20
...
function esVocal(letra){if (letra === 'a' || letra === 'e' || letra === 'i' || letra === 'o' || letra === 'u')
{return ('Es'+' '+'vocal')}
